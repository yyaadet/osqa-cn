...
class AskForm(forms.Form):
    ...
    expert_email = forms.EmailField(label=_('Expert Email (not shared with anyone):'), required=False, \
                                    help_text = _("You can send question to anyone by email, who will answer you instantly."))
